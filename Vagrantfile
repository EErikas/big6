...
Vagrant.configure("2") do |config|
  config.vm.define "box" do |box|
    ...
    box.vm.provision :shell,
      ...
      apt install unzip pkg-config autotools-dev automake gcc libcap-dev python3-dev liblua5.1-0-dev libselinux1-dev libapparmor-dev libapparmor-dev libapparmor-dev build-essential dnsmasq-base debootstrap rsync -y
